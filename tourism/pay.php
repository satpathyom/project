...
<!-- Mirrored from creativelayers.net/themes/viatours-html/about.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Feb 2024 04:19:19 GMT -->
...
<body>
  ...
  <main>
    ...
    <section class="layout-pt-lg">
      <div data-anim-wrap class="imgsrc">
        <div class="row y-gap-20 justify-between">
          <div class="about1">
            <img src="img/destinationCards/temple/img130.jpg" alt="Image" style="border-radius: 30px; height: 450px;
             margin-left:200px; width:500px">
            <div class="about2">
              <h3 style="font-size:x-large; margin-left:200px;"> PAYMENT</h3><br>
              <p style=" font-size:x-large; margin-left:200px;"><b>
                  Bank name: Indian overseas Bank,<br>
                  Branch: Bhapur,<br>
                  Account number: 117302000000233,<br>
                  IFSC Code: IOBA0001173,
                </b></p>
            </div>
          </div>
...
<!-- Mirrored from creativelayers.net/themes/viatours-html/about.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Feb 2024 04:19:26 GMT -->
