...
<!-- Mirrored from creativelayers.net/themes/viatours-html/register.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Feb 2024 04:17:26 GMT -->
  ...
  <div class="preloader js-preloader">
    <div class="preloader__wrap">
      <div class="preloader__icon">
        <svg width="41" height="31" viewBox="0 0 41 31" fill="none" xmlns="http://www.w3.org/2000/svg"><img class="front-logo" src="img\destinationCards\temple\img10.jpg">
        ...
        <div data-anim="slide-up" class="row justify-center">
          <div class="col-xl-6 col-lg-7 col-md-9">
            <div class="text-center mb-60 md:mb-30">
              ...
              <div class="mt-5">
                Already have an account? <a href="login.html" class="text-accent-1">Log In!</a>
              </div>
            </div>
